...
- **Variable** — Declare and set variables for use across blocks
- **Transform** — Map and transform data between blocks
- **Delay / Timer** — Pause execution or schedule delayed actions
- **If / Else** — Conditional branching based on expressions
- **Loop** — Iterate over arrays or repeat actions N times
